...
-- add Foreign keys --
ALTER TABLE PERSON
	ADD (CONSTRAINT FK_PERSON_ADDRESS_ID FOREIGN KEY (ADDRESS_ID)
...
--- add INDEXEN --
CREATE INDEX IDX_PERSON_NAME ON PERSON (LAST_NAME) TABLESPACE ADRESBESTAND_TS;
CREATE INDEX IDX_PERSON_FIRSTNAME ON PERSON (FIRST_NAME) TABLESPACE ADRESBESTAND_TS;
CREATE INDEX IDX_ADDRESS_STREET ON ADDRESS (STREET) TABLESPACE ADRESBESTAND_TS;
CREATE INDEX IDX_ADDRESS_CITY ON ADDRESS (CITY) TABLESPACE ADRESBESTAND_TS;
